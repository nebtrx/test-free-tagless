# Free Monads vs Tagless Finals 

Ths repository is a compilation of examples of Free Monads  vs Tagless Finals 
in several scenarios. More explicitly, cats way vs freestyle(still to be implemented) way

The code was taken, and slightly modified, from the one shown in the
